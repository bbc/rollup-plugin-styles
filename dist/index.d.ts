...
/** URL resolver */
declare type UrlResolve = (url: string, basedir: string) => Promise<UrlFile>;
...
interface Options {
     ...
     */
    plugins?: Record<string, unknown> | (postcss.Transformer | postcss.Processor | string | [string | postcss.Plugin<unknown>] | [string | postcss.Plugin<unknown>, Record<string, unknown>] | null | undefined)[];
    /**
